...
public class Resume_Maker  {	
    ...
    Button b1; // Button to Submit a File 
	...
	public void eQualification()
	{
		 l2 = new Label ("EDUCATIONAL QUALIFICATIONS");
			...
			e[2]= new Label ("Year");
			 ...
			 e[3]= new Label ("Percent/GPA");
			 e[3].setBounds(1450,150,90, 40);
      ...
      public void workExp()
      {
    	  l3 = new Label ("WORK EXPERIENCE");
			...
			we[1] = new Label ("From");
			we[1].setBounds(1060,440, 80,30);
			we[1].setFont(new Font("Cambria",Font.PLAIN,14));
			we[2]= new Label ("To");
			we[2].setBounds(1140,440,100,30);
		   ...
		   for(int i=0;i<9;i++)
			{
				...
				if((i+1)%3==1)
	               ...
	               {
	            	   twe[i].setBounds(1050, 480+(j*50),60,30);
		                  
	               }
	               else if((i+1)%3==0)
	               {
	            	   twe[i].setBounds(1140,480+(j*50),60,30);
		               j++;          
	               }
			}
			for(int i=0;i<9;i++)
	...
	public void skills()
	{
		 l4 = new Label ("SKILLS");
		    ...
		    l4.setBounds(100,480,200,30);
		    f.add(l4);
		    ts = new TextField[4];
		    for(int i=0;i<1;i++)
		    {
		       ts[i]=new TextField();
		       ts[i].setBounds(50,540+i*50,400,150);
		    }
			for(int i=0;i<1;i++)
		{
		    f.add(ts[i]);
	...
	public void generateFile()    // Method to generate file
	{
		...
		f.add(b2);
		 b1.addActionListener(new ActionListener()
		 {
			...
			if(a=="SUBMIT"&&c)   // if button is pressed
			{
	         ...
	         temp.setText("File has been generated! ");
				 ...
				 temp.setText("FILL THE NECESSARY DETAILS!");
			}
			  f.add(temp);
			}
 		 });
		 b2.addActionListener(new ActionListener()
		 {
			...
			{
			String a= e.getActionCommand();
			if(a=="CLEAR")  // if button is pressed
			{
...
{
	Resume_Maker f =new Resume_Maker();
}
}
